...
<div class="container-fluid py-5">
  <div class="container">
      ...
      <div class="row g-4">
          <div class="col-lg-4 col-md-6">
              <div class="product-item bg-white text-center p-4">
                  <img class="img-fluid mb-4" src="img/product-1.png" alt="">
                  <h2 class="mb-3">Organic Vegetable</h2>
                  <div class="btn-action d-flex justify-content-center mt-3">
                      <a class="btn bg-primary py-2 px-3 me-2" href=""><i class="bi bi-cart text-white"></i></a>
          ...
          <div class="col-lg-4 col-md-6">
              <div class="product-item bg-white text-center p-4">
                  ...
                  <h2 class="mb-3">Organic Fruit</h2>
                  <div class="btn-action d-flex justify-content-center mt-3">
                      <a class="btn bg-primary py-2 px-3 me-2" href=""><i class="bi bi-cart text-white"></i></a>
                      <a class="btn bg-secondary py-2 px-3" href=""><i class="bi bi-eye text-white"></i></a>
                  </div>
